...
public final class Querys {
	...
	public static final String UPDATE = "update base\n" +
		...
		"where id =  ?";
	public static final String SELECT = "select id, idKey, text, description from base order by idKey desc, text ;";

	/**
	 * В данном запросе необходимо делать replace "-" на нужный символ.
	 */
	public static final String SELECT_SEARCH = "select id, idKey, text, description from base"
